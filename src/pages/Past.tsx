...
const App = () => {
  ...
  useEffect(() => {
    ...
    function formatToUTC(dateInput:any) {
      ...
      <main className="w-full max-w-scree px-50">
        <ul className="bg-[#e8e8e8]">
            <div className='py-4 px-13'>
                <span className='text-[#828282]'>Stories from {formatToUTC(date).toString()}</span>
                <div className='flex pt-1'>
                    <span className='mr-1 text-base text-gray-500'>Go back a</span>
                    <div>
                        <span className='text-base text-gray-500 underline mr-1 cursor-pointer'> day,</span>
                        <span className='text-base text-gray-500 underline mr-1 cursor-pointer'>month,</span>
                        <span className='text-base text-gray-500 underline mr-1'>or</span>
                        <span className='text-base text-gray-500 underline cursor-pointer'>year.</span>
                    </div>
                </div>
            </div>

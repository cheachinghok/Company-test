            ...
            <li key={story.id} className="px-5 py-2 duration-200">
                <div>
                    ...
                    <a 
                        ...
                        <span className='text-xs text-gray-500'>(</span><span className='text-xs text-gray-500 hover:underline'>{story.url ? new URL(story.url).hostname.replace(/^www\./, '') : ""}</span><span className='text-xs text-gray-500'>)</span>
                    </a> 
                </div>
